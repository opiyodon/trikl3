          ...
          <nav className="flex items-center space-x-4">
            {navItems.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className={`px-3 py-2 rounded-md transition ${item.name === 'Post Internship'
                    ? 'bg-blue-500 text-white' // This will make the 'Post Internship' button blue with white text
        ...
        <div className="px-4 sm:px-0">
          ...
          <div className="mt-8">
            ...
            <div className="mt-4 space-y-4">
              <div className="bg-white p-4 rounded shadow-sm w-full flex justify-between">
                <div>
            ...
            <div className="mt-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {[
                ...
                <div key={index} className="bg-white p-4 rounded shadow-sm flex flex-col items-center">
                  <img src={internship.logo} alt={`${internship.company} logo`} className="w-16 h-16 mb-4 object-cover" />
